...
## 🚀 Need Help Running Cart Radar?

> **Full setup documentation:** Please see [`docs/DOCKER_SETUP.md`](docs/DOCKER_SETUP.md) for detailed one-click installation and running instructions.
...
4. Guide me to run the correct installation script for my OS:
   - macOS   → double-click "Cart Radar Install.command" inside the cart-radar/ folder
   - Windows → double-click "Cart Radar Install.bat" inside the cart-radar/ folder
   - Linux   → run "Cart Radar Install.desktop" inside the cart-radar/ folder
5. Guide me to run the correct launcher file for everyday use:
   - macOS   → double-click "Cart Radar.command"
   - Windows → double-click "Cart Radar.bat"
   - Linux   → run "Cart Radar.desktop"
6. Tell me what URL to open once it's running: http://localhost:3000
7. Help me troubleshoot any Docker startup errors by reading the error
   messages I paste to you — check the repository README and docs/DOCKER_SETUP.md
   for known issues and solutions.
8. Do not ask me to manually edit application source code unless absolutely necessary.
```
