...
(cd backend && DEV_MODE=1 ENABLED_PLATFORMS=zepto,swiggy,bigbasket,blinkit,bbnow,flipkart,flipkart_minutes uv run python -m uvicorn app.main:app --port 8000 --reload) &
